! function(e) {
 ...
 o.VantaBase = class {
  constructor(e = {}) {
   ...
   if (o.current = this, this.onMouseMoveWrapper = this.onMouseMoveWrapper.bind(this), this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this), this.options = Object(s.c)({}, this.defaultOptions), e instanceof HTMLElement || "string" == typeof e ? Object(s.c)(this.options, {
     el: e
    }) : Object(s.c)(this.options, e), this.el = this.options.el, null == this.el) n('Instance needs "el" param!');
   else if (!(this.options.el instanceof HTMLElement || (a = this.el, this.el = Object(s.e)(a), this.el))) return void n("Cannot find element", a);
   ...
   try {
    ...
    return i = e, n("Init error"), n(i), this.el.removeChild(this.renderer.domElement), void(this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = this.color2Hex(this.options.backgroundColor)))
   }
  ...
  setSize() {
   ...
   Object(s.d)() && this.options.scaleMobile ? this.scale = this.options.scaleMobile : this.options.scale && (this.scale = this.options.scale), this.width = this.el.width || window.innerWidth,
  ...
  resize() {
   ...
   this.setSize(),
       ...
       null != (t = this.camera) && "function" == typeof t.updateProjectionMatrix && t.updateProjectionMatrix(),
 ...
 class n extends s.b {
  ...
  resize() {
   super.resize(), this.p5 && this.p5.resizeCanvas && this.p5.resizeCanvas(window.innerWidth, window.innerHeight)
  }
 }
}, , , , function(e, t, i) {
 "use strict";
   ...
   new p5(function(t) {
    ...
    function m(e, i, s) {
     let o = 0,
      ...
      a = t.createVector(0, 0);
     for (var h = 0; h < 100; h++) {
      let u = h / 100 * t.TAU,
       c = t.createVector(e + t.cos(u) * s, i + t.sin(u) * s),
       l = t.noise(c.x, c.y);
      l > o && (o = l, r.x = c.x, r.y = c.y), l < n && (n = l, a.x = c.x, a.y = c.y)
     }
     let u = t.createVector(a.x - r.x, a.y - r.y);
     return u.normalize().mult(o - n), u
    }
    ...
    t.setup = function() {
     e.initP5(t), t.smooth(), t.noStroke(),
      function() {
       for (var e = 0; e < p; e++) {
        let i = t.random(t.width + 2 * n),
         s = t.random(t.height + 2 * n);
        d.push({
         prev: t.createVector(i, s),
         pos: t.createVector(i, s),
      ...
      function() {
       for (let e = 0; e < c; e++) {
        let t = [];
        for (let i = 0; i < u; i++) t.push(m(i * a, e * a, h));
        l.push(t)
       }
      }()
    }, t.draw = function() {
     t.translate(-n, -n),
      function() {
       for (var e = 0; e < p; e++) {
        let o = d[e],
         a = (i = o.pos.x, s = o.pos.y, i = t.constrain(i, 0, t.width + 2 * n), s = t.constrain(s, 0, t.height + 2 * n), l[t.floor(s / r)][t.floor(i / r)]);
        o.prev.x = o.pos.x, o.prev.y = o.pos.y, o.pos.x = v(o.pos.x + o.vel.x, t.width + 2 * n), o.pos.y = v(o.pos.y + o.vel.y, t.height + 2 * n), o.vel.add(o.acc).normalize().mult(2.2), o.acc = t.createVector(0, 0), o.acc.add(a).mult(3)
       }
       var i, s
      }(),
      function() {
       t.strokeWeight(1), t.stroke(Object(o.b)(e.options.color, .05));
       for (let e = 0; e < d.length; e++) p5.Vector.dist(d[e].prev, d[e].pos) < 10 && t.line(d[e].prev.x, d[e].prev.y, d[e].pos.x, d[e].pos.y)
      }(), f += .002
    }
   })
  }
 }
 n.initClass(), s.a.register("TOPOLOGY", n)
}]);