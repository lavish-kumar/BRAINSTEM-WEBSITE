...
(function($) {
  ...
  !function(e) {
      ...
      y.prototype.css = function(t, n) {
          ...
          n.transform && (c && (n.transform += " translateZ(0)"),
          n.WebkitTransform = n.MozTransform = n.msTransform = n.OTransform = n.transform);
          for (var i in n)
              t.style[i] = n[i];
          return t
      }
      ...
      var v = function(e) {
          ...
          for (a; a < o; a++)
              if ("object" == typeof n || "undefined" == typeof n ? e[a].jarallax || (e[a].jarallax = new y(e[a],n)) : e[a].jarallax && (t = e[a].jarallax[n].apply(e[a].jarallax, i)),
              "undefined" != typeof t)
                  return t;
          return e
      };
  ...
  !function(e) {
      ...
      a.prototype.parseURL = function(e) {
          ...
          function o(e) {
              for (var t = e.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), i = {}, o = 0, a = 0; a < t.length; a++) {
                  ...
                  n && n[1] && n[2] && (i["ogv" === n[1] ? "ogg" : n[1]] = n[2],
                  o = 1)
              }
              return !!o && i
          }
      ...
      a.prototype.getIframe = function(t) {
          ...
          return i.$iframe ? void t(i.$iframe) : void i.onAPIready(function() {
              ...
              "youtube" === i.type) {
                  ...
                  i.playerOptions.events = {
                      ...
                      onStateChange: function(e) {
                          ...
                          r || e.data !== YT.PlayerState.PLAYING || (r = 1,
                          i.fire("started", e)),
                          ...
                          i.options.endTime && (e.data === YT.PlayerState.PLAYING ? p = setInterval(function() {
              ...
              if ("vimeo" === i.type) {
                  ...
                  i.$iframe || (i.$iframe = document.createElement("iframe"),
      ...
      a.prototype.loadAPI = function() {
          ...
          if (!n || !r) {
              var i = "";
              if ("youtube" !== t.type || n || (n = 1,
              i = "//www.youtube.com/iframe_api"),
              "vimeo" !== t.type || r || (r = 1,
              i = "//player.vimeo.com/api/player.js"),
              i) {
      ...
      a.prototype.onAPIready = function(t) {
          ...
          "vimeo" === i.type)
              if ("undefined" != typeof Vimeo || s)
                  "undefined" != typeof Vimeo ? t() : d.done(function() {
                      t()
                  });
              else {
                  s = 1;
                  var o = setInterval(function() {
                      "undefined" != typeof Vimeo && (clearInterval(o),
                      d.resolve("done"),
                      t())
                  }, 20)
              }
  ...
  function() {
      ...
      if ("undefined" != typeof jarallax) {
          ...
          e.prototype.initImg = function() {
              var e = this
                , t = o.apply(e);
              if (e.options.videoSrc || (e.options.videoSrc = e.$item.getAttribute("data-jarallax-video") || !1),
              e.options.videoSrc) {
                  var i = new VideoWorker(e.options.videoSrc,{
                      startTime: e.options.videoStartTime || 0,
                      endTime: e.options.videoEndTime || 0
                  });
                  if (i.isValid() && (e.image.useImgTag = !0,
                  i.on("ready", function() {
                      var t = e.onScroll;
                      e.onScroll = function() {
                          t.apply(e),
                  ...
                  e.video = i,
                  "local" !== i.type && i.getImageURL(function(t) {
                      e.image.src = t,
                      e.init()
                  })),
                  "local" !== i.type)
                      return !1;
                  if (!t)
                      return e.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
                      !0
              }
              return t
          }
  ...
  !function() {
      ...
      function t() {
          if (!X && document.body) {
              ...
              var t = document.body
                ...
                , r = t.scrollHeight;
              if (Y = document.compatMode.indexOf("CSS") >= 0 ? o : t,
              k = t,
              e(),
              top != self)
                  O = !0;
                  ...
                  a.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + Y.scrollHeight + "px",
      ...
      function n(e, t, o) {
          ...
          1 != z.accelerationMax) {
              ...
              if (n < z.accelerationDelta) {
                  var r = (1 + 50 / n) / 2;
                  r > 1 && (r = Math.min(r, z.accelerationMax),
                  t *= r,
                  o *= r)
              }
              q = Date.now()
              ...
              var a = e === document.body
                , i = function(n) {
                  ...
                  if (a) {
                      window.scrollBy(l, c);
                      var p;
                      document.createEvent ? (p = document.createEvent("HTMLEvents")).initEvent("smoothScrollCustomEvent", !0, !0) : (p = document.createEventObject()).eventType = "smoothScrollCustomEvent",
                      p.eventName = "smoothScrollCustomEvent",
                      document.createEvent ? window.dispatchEvent(p) : window.fireEvent("on" + p.eventType, p)
                  } else
                      l && (e.scrollLeft += l),
                      c && (e.scrollTop += c);
                  t || o || (P = []),
      ...
      function r(e) {
          ...
          if (e.defaultPrevented || e.ctrlKey)
              return !0;
          if (h(k, "embed") || h(o, "embed") && /\.pdf/i.test(o.src) || h(k, "object") || o.shadowRoot)
              return !0;
          var r = -e.wheelDeltaX || e.deltaX || 0
            , a = -e.wheelDeltaY || e.deltaY || 0;
          B && (e.wheelDeltaX && y(e.wheelDeltaX, 120) && (r = e.wheelDeltaX / Math.abs(e.wheelDeltaX) * -120),
          e.wheelDeltaY && y(e.wheelDeltaY, 120) && (a = e.wheelDeltaY / Math.abs(e.wheelDeltaY) * -120)),
          r || a || (a = -e.wheelDelta || 0),
          1 === e.deltaMode && (r *= 40,
          a *= 40);
          var i = u(o);
          return i ? !(z.touchpadSupport || !v(a)) || (Math.abs(r) > 1.2 && (r *= z.stepSize / 120),
      ...
      function a(e) {
          ...
          if (e.defaultPrevented || r.test(t.nodeName) || h(t, "input") && !a.test(t.type) || h(k, "video") || g(e) || t.isContentEditable || o)
              return !0;
          if ((h(t, "button") || h(t, "input") && a.test(t.type)) && e.keyCode === K.spacebar)
              return !0;
          if (h(t, "input") && "radio" == t.type && j[e.keyCode])
              return !0;
          var i = 0
            , c = 0
            , d = u(k);
          if (!d)
              return !O || !J || parent.keydown(e);
          var s = d.clientHeight;
          switch (d == document.body && (s = window.innerHeight),
          e.keyCode) {
          case K.up:
              c = -z.arrowScroll;
              break;
      ...
      function S(e) {
          ...
          e < 1 ? t = e - (1 - Math.exp(-e)) : (e -= 1,
          t = (o = Math.exp(-1)) + (1 - Math.exp(-e)) * (1 - o)),
          t * z.pulseNormalize
      }
  
      function x(e) {
          return e >= 1 ? 1 : e <= 0 ? 0 : (1 == z.pulseNormalize && (z.pulseNormalize /= S(1)),
          S(e))
      }
      ...
      var k, D, M, T, C, H = {
          ...
          x: 0,
          y: 0
      }, X = !1, Y = document.documentElement, A = [], B = /^Mac/.test(navigator.platform), K = {
          left: 37,
          up: 38,
          right: 39,
          down: 40,
      ...
      }(), U = window.navigator.userAgent, G = /Edge/.test(U), J = /chrome/i.test(U) && !G, Q = /safari/i.test(U) && !G, Z = /mobile/i.test(U), ee = /Windows NT 6.1/i.test(U) && /rv:11/i.test(U), te = Q && (/Version\/8/i.test(U) || /Version\/9/i.test(U)), oe = (J || Q || ee) && !Z;
      "onwheel"in document.createElement("div") ? I = "wheel" : "onmousewheel"in document.createElement("div") && (I = "mousewheel"),
      I && oe && (window.isSmoothScroll = !0,
      f(I, r),
      f("mousedown", i),
      f("load", t)),
      E.destroy = o,
